(function () {
  ...
  ShoppingListControllerNew1.$inject = ['ShoppingListFactory', 'toastr'];
  function ShoppingListControllerNew1(ShoppingListFactory, toastr) {
    var vm = this;
  ...
  angular
        .module('CourseraSPA')
        .controller('ShoppingListControllerNew1', ShoppingListControllerNew1)
})();
