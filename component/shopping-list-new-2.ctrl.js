(function () {
  ...
  ShoppingListControllerNew2.$inject = ['ShoppingListFactory', 'toastr'];
  function ShoppingListControllerNew2(ShoppingListFactory, toastr) {
    var vm = this,
        maxItems = 3,
  ...
  angular
        .module('CourseraSPA')
        .controller('ShoppingListControllerNew2', ShoppingListControllerNew2)
})();
